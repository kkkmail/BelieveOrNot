// Server/wwwroot/king/js/utils/copyMatchId.js
export async function copyMatchId() {
    ...
    try {
        ...
        console.log('King match ID copied to clipboard:', matchIdInput.value);
    } catch (err) {
        console.error('Failed to copy King match ID:', err);
